...
import { FaBoxes, FaBoxOpen, FaClipboardList, FaClock, FaCog, FaPlusCircle, FaUsers } from "react-icons/fa";
import { Link, useNavigate } from "react-router-dom";
import "../App.css"; // garante que o CSS esteja sendo importado
        ...
        <header className="custom-header">
            <div className="custom-header-container">
                <nav className="custom-nav">
                    <Link to="/pedidos" className="custom-nav-link">
                        <FaClipboardList className="custom-icon" /> Pedidos
                    </Link>
                    <Link to="/crud-catalogo" className="custom-nav-link">
                        <FaBoxes className="custom-icon" /> Catálogos
                    </Link>
                    <Link to="/crud-produto" className="custom-nav-link">
                        <FaBoxOpen className="custom-icon" /> Produtos
                    </Link>
                    <Link to="/crud-adicional" className="custom-nav-link">
                        <FaPlusCircle className="custom-icon" /> Adicionais
                    </Link>
                    <Link to="/crud-horario" className="custom-nav-link">
                        <FaClock className="custom-icon" /> Horários
                    </Link>
                    <Link to="/crud-conta" className="custom-nav-link">
                        <FaUsers className="custom-icon" /> Contas
                    </Link>
                    <Link to="/configuracao" className="custom-nav-link">
                        <FaCog className="custom-icon" /> Configuração
                    </Link>
                </nav>
